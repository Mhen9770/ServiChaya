...
import { LayoutDashboard, ClipboardList, Briefcase, User, DollarSign, MessageCircle, Users, MessageSquare, Share2 } from 'lucide-react'
...
export default function ProviderSidebar() {
  const items = [
    ...
    { label: 'Chat', href: '/provider/chat', icon: MessageSquare },
    { label: 'Referral & Marketing', href: '/provider/referral', icon: Share2 },
