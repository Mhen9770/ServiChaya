...
export default function ProviderChatPage() {
  ...
  useEffect(() => {
    ...
    if (!currentUser) {
      router.push('/login?redirect=/provider/chat')
      return
    }
    fetchConversations()
  }, [])
  ...
  const handleConversationClick = (conversation: ConversationDto) => {
    router.push(`/provider/chat/${conversation.conversationId}`)
  }
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        {conversations.length === 0 ? (
          ...
          >
            ...
            <p className="text-slate-400 text-sm">Start chatting with customers from your jobs</p>
          </motion.div>
        ) : (
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-white text-sm truncate">{conversation.customerName}</h3>
