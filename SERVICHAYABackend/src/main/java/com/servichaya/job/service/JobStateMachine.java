...
public class JobStateMachine {
    ...
    static {
        VALID_TRANSITIONS.put("PENDING", Set.of("MATCHING", "CANCELLED"));
        VALID_TRANSITIONS.put("MATCHING", Set.of("MATCHED", "CANCELLED", "PENDING")); // Can go back to PENDING if no providers found
        VALID_TRANSITIONS.put("MATCHED", Set.of("PENDING_FOR_PAYMENT", "ACCEPTED", "CANCELLED", "MATCHING")); // Can go to PENDING_FOR_PAYMENT if payment required, or ACCEPTED if POST_WORK
        VALID_TRANSITIONS.put("PENDING_FOR_PAYMENT", Set.of("ACCEPTED", "CANCELLED")); // After payment, move to ACCEPTED
        VALID_TRANSITIONS.put("ACCEPTED", Set.of("IN_PROGRESS", "CANCELLED"));
        VALID_TRANSITIONS.put("IN_PROGRESS", Set.of("PAYMENT_PENDING", "CANCELLED"));
        VALID_TRANSITIONS.put("PAYMENT_PENDING", Set.of("COMPLETED", "CANCELLED"));
