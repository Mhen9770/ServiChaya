-- ============================================
-- TEST QUERY FOR JOB ID = 4
-- Values: pod_id=4, service_category_id=3, service_skill_id=3, zone_id=4, city_id=2
-- ============================================
-- Run VERIFY_MATCHING_DATA.sql first to check data availability
-- ============================================
